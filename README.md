...
| Thu, Jan 25, morning session       |  Using ML APIs with Python <br/>(Google Cloud Vision)                |       |       |       |
| Thu, Jan 25, afternoon session     |  Using Language Models with Python <br/>(Transformers Library)       |       |       |       |
| < TBD                              |  Exam Exercise                                                       | -     |       |  -    |
